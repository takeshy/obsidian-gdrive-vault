...
const translations = {
	en: {
		...
		tempFilesButton: 'Manage Temporary Files',
		tempFilesButtonDesc: 'View, download, or delete temporary sync files',
		tempFilesDialogTitle: 'Temporary Files',
		tempFilesDialogDesc: 'Files uploaded via temporary sync. Select to download or delete.',
	...
	ja: {
		...
		tempFilesButton: '一時ファイルを管理',
		tempFilesButtonDesc: '一時同期ファイルの表示・ダウンロード・削除',
		tempFilesDialogTitle: '一時ファイル',
		tempFilesDialogDesc: '一時同期でアップロードされたファイル。選択してダウンロードまたは削除できます。',
		noTempFiles: '一時ファイルはありません',
		downloadSelected: '選択をダウンロード ({count})',
